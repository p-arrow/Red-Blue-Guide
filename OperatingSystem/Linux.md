...
## MONITORING
### Types
- Signature based (least false positives)
- Anomaly based (more false positives): Prescribed patterns (e.g. RFC, industry standards)
- Behaviour based (most false positives): Patterns that BlueTeam describe themselves
